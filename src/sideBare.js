...
function handleAddingProject(){
 ...
 document.querySelector('.project-box').insertBefore(div,document.querySelector('#add-project'));
    }
...
function displayProjectContent(){
    ...
    const addProject = renderBoxWithTextIcon("Add Project",addCercle,"add-project");
